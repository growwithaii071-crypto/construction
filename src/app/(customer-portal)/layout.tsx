...
import { HardHat, Building2, Phone, Mail, MapPin, Star, ShieldCheck, Clock } from "lucide-react";
  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-950">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link
              ...
              className="flex items-center gap-1.5 text-sm font-semibold text-orange-400 border border-orange-400/30 bg-orange-400/10 hover:bg-orange-400/20 px-3 py-2 rounded-lg transition-colors"
            >
      ...
      <main className="flex-1 relative flex items-center justify-center px-4 py-12 overflow-hidden">
        {/* Gradient bg */}
        <div className="absolute inset-0 bg-linear-to-br from-slate-950 via-violet-950/50 to-slate-950" />
        {/* Grid pattern */}
        ...
        {/* Glow */}
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[600px] h-[400px] bg-violet-600/15 rounded-full blur-[100px]" />
        ...
        <div className="relative z-10 w-full max-w-5xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-center">
            ...
            <div className="hidden lg:block text-white pr-8">
              <div className="inline-flex items-center gap-2 bg-violet-500/20 border border-violet-400/30 rounded-full px-3 py-1.5 mb-6">
                <Building2 className="w-3.5 h-3.5 text-violet-400" />
                <span className="text-violet-300 text-xs font-semibold">Customer Portal</span>
              </div>
              <h1 className="text-4xl font-extrabold leading-tight mb-4">
                Track every detail of
                <span className="block text-violet-400">your project</span>
              </h1>
              <p className="text-white/50 text-base leading-relaxed mb-10">
                From posting your first job to final handover — manage everything in one place.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 rounded-2xl p-5">
                ...
                <p className="text-white/70 text-sm leading-relaxed italic">
                  &ldquo;BuildPro made finding trusted contractors so easy. Got 5 quotes in 24 hours — project finished on time and on budget!&rdquo;
                </p>
                <div className="flex items-center gap-2.5 mt-4">
                  <div className="w-8 h-8 bg-violet-600 rounded-full flex items-center justify-center text-white text-xs font-bold">RS</div>
                  <div>
                    <p className="text-white text-sm font-semibold">Rajesh Sharma</p>
                    <p className="text-white/40 text-xs">Property Developer, Mumbai</p>
                  </div>
                </div>
              </div>
            ...
            <div className="w-full">
              <div className="bg-white rounded-3xl shadow-2xl shadow-black/40 overflow-hidden">
                {/* Card top accent */}
                <div className="h-1.5 bg-linear-to-r from-violet-500 via-violet-600 to-indigo-600" />
              ...
              <div className="flex items-center justify-center gap-4 mt-5 text-sm text-white/40">
                <Link href="/construction/login" className="hover:text-white/70 transition-colors">
                  Contractor Login
                </Link>
                <span>·</span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-6">
            <div>
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-white font-bold text-sm">Build<span className="text-violet-400">Pro</span></span>
              </div>
              <p className="text-xs text-white/30 leading-relaxed">
                India&apos;s leading construction platform connecting customers with verified professionals.
              </p>
            </div>
            <div>
