    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="mt-1.5 text-sm text-gray-500">
          Sign in to your customer account to manage your projects
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
        ...
        <Button
          type="submit"
          disabled={isPending}
          className="w-full bg-blue-600 hover:bg-blue-700 text-white h-11 rounded-xl font-semibold transition-colors"
        >
          {isPending ? (
            <>
      ...
      <div className="relative">
        ...
        <div className="relative flex justify-center text-xs text-gray-400 bg-white px-3">
          <span className="bg-white px-2">New to BuildPro?</span>
        </div>
      </div>

      <Link
        href="/customer/register"
        className="flex items-center justify-center gap-2 w-full border border-gray-200 text-gray-700 hover:bg-gray-50 font-semibold h-11 rounded-xl text-sm transition-colors"
      >
