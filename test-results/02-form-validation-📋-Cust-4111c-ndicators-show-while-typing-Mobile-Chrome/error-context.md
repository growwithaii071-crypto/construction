...
- Name: 02-form-validation.spec.ts >> 📋 Customer Registration — Validation >> password strength indicators show while typing
- Location: e2e/02-form-validation.spec.ts:39:7
