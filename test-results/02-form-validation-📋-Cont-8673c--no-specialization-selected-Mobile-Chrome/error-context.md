...
- Name: 02-form-validation.spec.ts >> 📋 Contractor Registration — Validation >> shows error if no specialization selected
- Location: e2e/02-form-validation.spec.ts:87:7
