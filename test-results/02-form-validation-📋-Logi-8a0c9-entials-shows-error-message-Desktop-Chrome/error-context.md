...
- Name: 02-form-validation.spec.ts >> 📋 Login Form Validation >> customer login — wrong credentials shows error message
- Location: e2e/02-form-validation.spec.ts:107:7
