...
- Name: 03-customer-journey.spec.ts >> 👤 Customer — Browse Services >> category filter pills are visible when services exist
- Location: e2e/03-customer-journey.spec.ts:92:7
