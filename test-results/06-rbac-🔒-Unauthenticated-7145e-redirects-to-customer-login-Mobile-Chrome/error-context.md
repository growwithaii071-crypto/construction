...
- Name: 06-rbac.spec.ts >> 🔒 Unauthenticated Access — Redirects to Login >> visiting /customer/requests redirects to /customer/login
- Location: e2e/06-rbac.spec.ts:20:7
