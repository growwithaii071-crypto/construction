...
- Name: 02-form-validation.spec.ts >> 📋 Contractor Registration — Validation >> can deselect a specialization by clicking X on tag
- Location: e2e/02-form-validation.spec.ts:75:7
