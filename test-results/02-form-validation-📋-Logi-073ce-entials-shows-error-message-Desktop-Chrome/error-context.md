...
- Name: 02-form-validation.spec.ts >> 📋 Login Form Validation >> contractor login — wrong credentials shows error message
- Location: e2e/02-form-validation.spec.ts:115:7
